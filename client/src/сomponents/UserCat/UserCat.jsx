        ...
        <>
            ...
            {Number(user?.id) === Number(id) ?
                click ?
                    ...
                    >
                        <Form.Item>
                            <Select style={{width: '60%', borderRadius: '5px', margin: 'auto'}}
                        ...
                        >
                            <input
                                name="title"
                                style={{width: '200px', borderRadius: '5px', border: 'none'}}
                                onChange={inputHendler}/>
                        </Form.Item>

                        <div style={{dispaly: 'flex'}}>

                            <button className="btn" type="primary" onClick={submitHandler}>
                                Разместить
                            </button>


                            <button className="btn" type="primary" onClick={clickHandler}>
                                закрыть
                            </button>
                        </div>
                    </form>
                    ...
                    :
                    <button className="btn" type="primary" onClick={clickHandler}>Я профи в ...</button> : ''}
